...
namespace Render{
    struct Camera{
        ...
        glm::vec3 orientation = glm::vec3(0.0f, 0.0f, -1.0f); // TODO: remove this lel
        constexpr static glm::vec3 up = glm::vec3(0.f, 1.f, 0.f);
        ...
        glm::mat4 generateViewProjectionMatrix(size_t width, size_t height){
            ...
            view = Render::Matrix::lookIn(pos, orientation, up); // TODO: I DONT LIKE THIS BUT ILL EDIT IT ONCE I GET THINGS WORKING
